...
use pocketmine\level\generator\LevelVoid;
...
class Server
{
    ...
    private mixed $networkCompressionAsync = true;
    public mixed $networkCompressionLevel = 7;
    ...
    public bool $foodEnabled = true;
    public bool $expEnabled = true;
    public bool $keepInventory = false;
    public bool $netherEnabled = false;
    public string $netherName = "nether";
    public ?Level $netherLevel = null;
    public int $weatherRandomDurationMin = 6000;
    public int $weatherRandomDurationMax = 12000;
    public int $lightningTime = 200;
    public bool $lightningFire = false;
    public VersionString $version;
    public bool $allowSnowGolem;
    public bool $allowIronGolem;
    public bool $autoClearInv = true;
    public array $dserverConfig = [];
    public int $dserverPlayers = 0;
    public int $dserverAllPlayers = 0;
    public bool $redstoneEnabled = false;
    public bool $allowFrequencyPulse = true;
    public bool $anvilEnabled = false;
    public int $pulseFrequency = 20;
    public int $playerMsgType = self::PLAYER_MSG_TYPE_MESSAGE;
    public string $playerLoginMsg = "";
    public string $playerLogoutMsg = "";
    public bool $antiFly = false;
    public bool $asyncChunkRequest = true;
    public bool $recipesFromJson = false;
    public bool $creativeItemsFromJson = false;
    public bool $checkMovement = false;
    public bool $keepExperience = false;
    public bool $limitedCreative = true;
    public int $chunkRadius = -1;
    public bool $destroyBlockParticle = true;
    public bool $allowSplashPotion = true;
    public bool $fireSpread = false;
    public bool $advancedCommandSelector = false;
    public array $synapseConfig = [];
    public bool $enchantingTableEnabled = true;
    public bool $countBookshelf = false;
    public bool $allowInventoryCheats = false;
    private ?CraftingDataPacket $recipeList = null;
    ...
    public function getiTXApiVersion(): string
    {
    ...
    public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, string $filePath, string $dataPath, string $pluginPath, string $defaultLang = "unknown")
    {
        self::$instance = $this;
        ...
        try {
            if (!file_exists($dataPath . "worlds/")) {
                mkdir($dataPath . "worlds/");
            }

            if (!file_exists($dataPath . "players/")) {
                mkdir($dataPath . "players/");
            }
            ...
            if ($this->getConfigBoolean("enable-rcon")) {
            ...
            Generator::addGenerator(LevelVoid::class, "void");
...
//            }
     ...
     */
    public function getAdvancedProperty(string $variable, $defaultValue = null, Config $cfg = null): mixed
    {
